...
import { FaPaperPlane, FaTrash, FaUserCircle } from 'react-icons/fa'; // Import FaUserCircle
						...
						<div key={post.id} className="community-post-item">
							<div className="post-header">
								...
								<div className="post-info">
									...
									<span className="post-date">{new Date(post.timestamp.seconds * 1000).toLocaleString()}</span>
								</div>
